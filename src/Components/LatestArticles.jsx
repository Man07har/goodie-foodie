  ...
  return (
    <>
      <div className=" rounded-4 border border-black m-4 flex flex-col justify-center p-12 rounded-[26.7px]">
        ...
        <h2 className="font-p font-bold my-2 text-navy font-bold mx-[-1em] text-xl text-center mb-6">
          {title}
        </h2>
  ...
  return (
    <>
      <div className=" m-3 p-3 min-h-screen my-36 ">
        <h1 className="heading text-center md:text-left headi font-semibold">
          Latest Articles
        </h1>
